...
* {Developing Backbone.js Applications}[https://github.com/addyosmani/backbone-fundamentals], written by Addy Osmani.
* {Pro Git}[https://github.com/progit/progit], written by Scott Chacon and published by Apress.
